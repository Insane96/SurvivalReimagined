...
execute if score WORLD_BORDER_GRAVEL world_border_setup matches 1.. run tellraw @a {"text": "Due to a glitch with commands, I recommend to re-join the world/server.", "color": "#FF0000"}
